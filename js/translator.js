function translate_story(nav) {
  ...
  idx = json[n].i;
  title = json[n].t;
  attribution = json[n].a.replace(/^(bns)\|(.*?)\|(.*)\|(\d)/, "* License: [CC $1]\n* Text: $2\n* Illustration: $3\n* Level: $4\n* Language: English\n").replace(/,/g, ", ").replace(/CC bns/, "CC BY-NC-SA").replace(/CC n/, "CC BY-NC");

  sections = json[n].s;
  img_index = 0 + sections.length + 6;

  first_img = '<a href="https://raw.githubusercontent.com/global-asp/lcb-imagebank/master/medium/' + idx + '/01.jpg" data-caption="' + title + '" tabindex="' + img_index + '"><img class="thumbnail" src="https://raw.githubusercontent.com/global-asp/lcb-imagebank/master/medium/' + idx + '/01.jpg" alt="image 01"></a>'
  content_div = "      <div class=\"gallery\"><table id=\"content_table\">\n        <tr><th style='width:5%'></th><th style='width:30%'>original isb story</th><th style='width:65%'>your translation</th></tr><tr>\n          <td>" + first_img + "</td>\n          <td id=\"title\"><h3>" + title + "</h3></td>\n          <td id=\"story_tgt_title\"><input type=\"text\" id=\"title_text\" tabindex=\"3\" /></td></tr><tr>\n";
  ...
  for (var i = 0; i < sections.length; i++) {
    ...
    lightbox_img = '<a href="https://raw.githubusercontent.com/global-asp/lcb-imagebank/master/medium/' + idx + '/' + page_number + '.jpg" data-caption="' + json[n].s[i][page_number] + '" tabindex="' + img_index + '"><img class="thumbnail" src="https://raw.githubusercontent.com/global-asp/lcb-imagebank/master/medium/' + idx + '/' + page_number + '.jpg" alt="image ' + page_number + '"></a>'
...
function review_translation() {
  ...
  if (translator.innerHTML == "") {
	...
	content_div = content_div + "          <td><img class=\"revthumb\" src=\"https://raw.githubusercontent.com/global-asp/lcb-imagebank/master/medium/" + idx + "/" + page_number + ".jpg\"></td>\n          <td>" + window["story_tgt_" + i].value + "</td>        </tr>"
      }
...
function prepare_submission() {
  ...
  sub.value = 'Indigenous Storybooks - New translation: #' + window.idx + ', "' + window.title + '" into ' + window.language.innerHTML + " by " + window.translator.innerHTML;
  ...
  window.rev_msg.innerHTML = "If you are satisfied with your translation, press the submit button below to send it for inclusion in the Indigenous Storybooks project:";
}
